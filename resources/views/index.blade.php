  ...
  <div id="about" class="container mt-4 px-2 px-lg-3">
    <div class="card">
      ...
      <div class="card-body p-sm-4">
        ...
        <p class="mb-0">
          この API は、そうしたニコニコ実況の過去ログを取り巻く現状を改善すべく、Nekopanda 氏が配布されている旧ニコニコ実況の 2020/12/15 までの全過去ログに加え、15 分に 1 回コミュニティからの番組も含めた新ニコニコ実況の今日分の過去ログを随時収集し、取得したデータを XML 形式や JSON 形式で提供する、非公式過去ログデータベース API です。</span><br>
