  ...
  <div id="about" class="container mt-4 px-2 px-lg-3">
    <div class="card">
      ...
      <div class="card-body p-sm-4">
        ...
        <p class="mb-0">
          この API は、そうしたニコニコ実況の過去ログを取り巻く現状を改善すべく、Nekopanda 氏が配布されている旧ニコニコ実況の 2020/12/15 までのすべての過去ログに加え、コミュニティからの番組も含めた新ニコニコ実況の当日分の過去ログを5分に1回収集し、取得したデータを XML 形式や JSON 形式で提供する、非公式の過去ログデータベース API です。</span><br>
  ...
  <div id="notes" class="container mt-4 px-2 px-lg-3">
    <div class="card">
      ...
      <div class="card-body p-sm-4">
        ...
        <ul class="mb-0">
          <li>2020年12月15日までに投稿された旧ニコニコ実況の全ての過去ログを取得できます。</li>
          <ul>
          ...
          <li>2020年12月16日以降に投稿された新ニコニコ実況の全ての過去ログを取得できます。</li>
          <ul>
            ...
            <ul>
              <li>その関係で、<span class="text-danger">たとえば 17:02 に終わった番組の過去ログを直後の 17:03 に取得する、といったことはできません。</span></li>
          ...
          <ul>
            <li>例えば 2009年11月26日（ニコニコ実況のリリース日）よりも前の時刻や、現在時刻よりも未来の時刻などです。</li>
          ...
          <ul>
            ...
            <li>GitHub から過去ログデータを取得するように変更し、API サーバーを VPS に置けるようになったことで、安定性が向上しています。</li>
          </ul>
        </ul>
      ...
      <p>
        ...
        <table class="table table-response, table-response-error">
          ...
          <tr>
            ...
            <td>
              障害が発生しているなどの理由により、GitHub のサーバーにアクセスできなかった際に起きるエラーです。<br>
              この API は過去ログデータを GitHub から取得しているため、GitHub で障害が発生している間は過去ログを取得できません。<br>
            </td>
          </tr>
        </table>
