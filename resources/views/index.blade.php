      ...
      <div class="card-body p-sm-4">
        ...
        <ul class="mb-0">
          ...
          <ul>
            ...
            <li><span class="text-info">公式チャンネル ( jk1・jk2・jk4・jk5・jk6・jk7・jk8・jk9・jk211 ) の放送に加えて、公式では廃止され、現在は <a href="https://com.nicovideo.jp/community/co5117214" target="_blank">有志のコミュニティ</a> から放送されている BS11 以外の BS 各局 ( jk101・jk103・jk141・jk151・jk161・jk171・jk181・jk222 ) の過去ログも収集しています。</span></li>
            <ul>
            ...
            <ul>
              ...
              <li>このため、API を利用するクライアントソフト側で運営コメントを全て弾いたり、/nicoad からメッセージだけ取り出して固定コメントとして描画したり…といった実装が必要になります。</li>
